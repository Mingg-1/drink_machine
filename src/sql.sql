...
insert into INGREDIENT (in_code, in_name, use_in_cnt, in_prc, wrh_in_cnt)
values ('I80', 'µþ±âÂ´', 5, 100, 4);
insert into INGREDIENT (in_code, in_name, use_in_cnt, in_prc, wrh_in_cnt)
values ('I90', '¼Ò±Ý', 5, 100, 4);
insert into INGREDIENT (in_code, in_name, use_in_cnt, in_prc, wrh_in_cnt)
values ('I100', '°èÇÇ°¡·ç', 5, 100, 5);
-----------------------------------------------------------------------
...
/*¹ßÁÖ Å×ÀÌºí(¹øÈ£,Àç·áÄÚµå,¹ßÁÖ³¯Â¥,¹ßÁÖ°³¼ö,¼ö·É³¯Â¥)*/
...
values (Dvr_Num_seq.nextval,'¹Ð°¡·ç', sysdate, 5, sysdate+DBMS_RANDOM.VALUE(30,180)/(24*60));
